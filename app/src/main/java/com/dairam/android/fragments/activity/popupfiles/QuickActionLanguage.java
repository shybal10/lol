package com.dairam.android.fragments.activity.popupfiles;
 ...
 */
public class QuickActionLanguage extends PopupWindows implements OnDismissListener {
	 ...
	 */
	public QuickActionLanguage(Context context) {
		super(context);
	...
	public void addActionItem(ActionItem action) {
		...
		Drawable icon 	= action.getIcon();
         ...
         setLanguage(lan);
		View container	= (View) inflater.inflate(R.layout.action_item_language, null);
		...
		container.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(QuickActionLanguage.this, pos, actionId);
                }
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(QuickActionLanguage source, int pos, int actionId);
	}
